...
function ListaProdutos() {
  ...
  const carregarProdutos = () => {
    axios.get('https://api-controle-estoque-hyam.onrender.com/api/produtos/', {
  ...
  const alternarStatus = async (produtoId, statusAtual) => {
    try {
      await axios.patch(`https://api-controle-estoque-hyam.onrender.com/api/produtos/${produtoId}/`, 
        { ativo: !statusAtual }, 
        { headers: { 'Authorization': `Token ${token}` } }
      )
