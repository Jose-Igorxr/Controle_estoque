...
function Perfil() {
  ...
  useEffect(() => {
    ...
    axios.get('https://api-controle-estoque-hyam.onrender.com/api/usuario-logado/', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch('https://api-controle-estoque-hyam.onrender.com/api/usuario-logado/', dadosParaEnviar, {
        headers: { 'Authorization': `Token ${token}` }
      });
