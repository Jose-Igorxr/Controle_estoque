...
const ProdutoForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://api-controle-estoque-hyam.onrender.com/api/produtos/', 
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div>
            ...
            <select 
              ...
              required
              className="w-full px-4 py-2 bg-[#2a2a35] text-white border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            >
          ...
          <div>
            ...
            <textarea 
              ...
              rows="3"
              className="w-full px-4 py-2 bg-[#2a2a35] text-white border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none placeholder-gray-500"
            />
          </div>
          ...
          <div className="flex gap-3 mt-4">
            ...
            <button 
              type="submit"
              className="w-2/3 bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg"
            >
              Salvar Produto
            </button>
          </div>
